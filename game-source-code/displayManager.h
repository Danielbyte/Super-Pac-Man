...
class DisplayManager
{
    ...
    std::shared_ptr<raylib::Texture2D> reference_symbol = std::make_shared<raylib::Texture2D>();
    std::shared_ptr<raylib::Texture2D> flashing_symbol = std::make_shared<raylib::Texture2D>();
